...
WebUI.setText(findTestObject('Object Repository/Page_MSU Signature Library Outlook add-in/textarea_Signatures_Sig_title'), 
    'title')

WebUI.setText(findTestObject('Object Repository/Page_MSU Signature Library Outlook add-in/textarea_Signatures_Sig_message'), 
    'message')
